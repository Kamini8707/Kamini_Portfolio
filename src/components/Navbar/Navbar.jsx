...
const Navbar = () => {
  ...
  const handleMenuItemClick = (sectionId) => {
    ...
    if (section) {
      // You may need to adjust the scroll amount if a fixed header is covering content
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[10vw] ${
        isScrolled
          ? "bg-[#050414] bg-opacity-90 backdrop-blur-sm shadow-md"
          : "bg-transparent"
      }`}
    >
      <div className="text-white py-5 flex justify-between items-center relative">
        ...
        <div className="text-lg font-semibold cursor-pointer z-50">
          ...
          <span className="text-white">Kamini</span>
          <span className="text-[#8245ec]">/</span>
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/Kamini8707"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/kamini-prajapati-5328b3253/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
